...
class AjaxHandlers {
    ...
    public static function ajax_get_available_slots() {
        ...
        // Aplicar límite de 16 horas desde la hora actual de Madrid solo para alumnos
    ...
    public static function ajax_process_booking() {
        ...
        // Validar que la franja seleccionada esté al menos 16 horas en el futuro, salvo para administradores
        if ( ! current_user_can('manage_options') ) {
            $limit_datetime = new \DateTime('now', $madrid_timezone);
            $limit_datetime->add(new \DateInterval('PT16H'));
