    ...
    public static function ajax_verify_dni() {
        ...
        if ($alumno) {
            ...
            if (!$alumno->online && !$alumno->presencial) {
                wp_send_json_error('El DNI o Correo son incorrectos o ya tienen una cita registrada.');
            }
            ...
            wp_send_json_error('¡Estamos en ello! Si has abonado y tus datos son correctos, en breve podrás acceder');
        }
    }
