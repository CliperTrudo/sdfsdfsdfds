        ...
        success: function(response) {
          if (response.success) {
            if (response.data && response.data.length > 0) {
              ...
              calendarContainer.html('<p class="tb-message tb-message-info">No se encontraron franjas horarias disponibles con al menos 16 horas de antelación para este tutor en el rango de fechas seleccionado.</p>');
            }
          } else {
